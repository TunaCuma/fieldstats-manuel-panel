...
class SplitterManager:
    ...
    def __init__(self):
        ...
        # Add the horizontal splitter to the top container of the vertical splitter
        self.vertical_manager.add_to_top(self.horizontal_manager.get_splitter())
        
        # Create the layout preset manager
        self.layout_manager = LayoutPresetManager(self.vertical_manager, self.horizontal_manager)
    ...
    def handle_view_detach(self, view_name, views):
        ...
        if view_name in ['left', 'right']:
            ...
            # Get the current view dictionary and delegate to horizontal manager
