...
class LayoutManager(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.layout_menu = LayoutMenu(
            self.layout_menu_btn, 
            self.view_tracker, 
            self.splitter_manager
        )
    ...
    def add_left_view(self, view):
        ...
        self.view_tracker.register_view('left', view, self.splitter_manager.horizontal_splitter)
    ...
    def add_right_view(self, view):
        ...
        self.view_tracker.register_view('right', view, self.splitter_manager.horizontal_splitter)
    ...
    def add_transform_view(self, view):
        ...
        self.view_tracker.register_view('transform', view, self.splitter_manager.bottom_container)
