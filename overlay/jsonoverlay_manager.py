...
class JSONOverlayManager:
    ...
    def connect_signals(self):
        ...
        self.player.left_view.detachRequested.connect(self.detached_manager.create_detached_left_overlays)
        self.player.right_view.detachRequested.connect(self.detached_manager.create_detached_right_overlays)
        self.player.transform_view.detachRequested.connect(self.detached_manager.create_detached_transform_overlays)
        
        # Connect signals for reattaching
        self.player.left_view.reattachRequested.connect(self.detached_manager.clean_detached_left_overlays)
        self.player.right_view.reattachRequested.connect(self.detached_manager.clean_detached_right_overlays)
        self.player.transform_view.reattachRequested.connect(self.detached_manager.clean_detached_transform_overlays)
