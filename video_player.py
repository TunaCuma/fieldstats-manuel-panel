...
from PyQt6.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout, 
                               ...
                               QFileDialog, QLineEdit, QStyle, QGraphicsScene, QGraphicsView)
...
class VideoPlayer(QMainWindow):
    def __init__(self):
        ...
        # Create graphics scene and view for video and overlays
        ...
        # Set up media player and audio output
        self.media_player = QMediaPlayer()
        self.audio_output = QAudioOutput()
        self.media_player.setAudioOutput(self.audio_output)
        self.media_player.setVideoOutput(self.video_item)
        
        # Create rectangle overlays and assign click callbacks
        ...
        # Position the rectangle overlays within the view
    ...
    def adjust_items_position(self):
        """Adjust positions and sizes of video and overlay items."""
    ...
    def duration_changed(self, duration):
        ...
        try:
            if duration > 0:
                self.fps = 30 if duration < 10000 else 25
            else:
                self.fps = 30
        except Exception:
            self.fps = 30
